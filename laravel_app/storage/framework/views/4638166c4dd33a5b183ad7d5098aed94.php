...
<?php $__env->startSection('nav'); ?>
  ...
  <a href="<?php echo e(route('etudiant.profil')); ?>" class="nav-item active">
...
<div class="kpi-grid-2">
  <div class="kpi-card">
    ...
    <div class="kpi-valeur"><?php echo e($nb_cand); ?></div>
  </div>
  <div class="kpi-card">
    <div class="kpi-label">Documents</div>
    <div class="kpi-valeur"><?php echo e($nb_doc); ?></div>
  </div>
</div>
...
<div class="section-card">
  ...
  <table>
    <tbody>
      <tr><td style="color:var(--gris);width:180px;">Nom</td><td><?php echo e($etudiant->utilisateur->nom ?? '—'); ?></td></tr>
      <tr><td style="color:var(--gris);">Prénom</td><td><?php echo e($etudiant->utilisateur->prenom ?? '—'); ?></td></tr>
      <tr><td style="color:var(--gris);">Email</td><td><?php echo e($etudiant->utilisateur->email ?? '—'); ?></td></tr>
      <tr><td style="color:var(--gris);">Numéro étudiant</td><td><?php echo e($etudiant->numero_etudiant ?? '—'); ?></td></tr>
      <tr><td style="color:var(--gris);">Niveau</td><td><?php echo e($etudiant->niveau ?? '—'); ?></td></tr>
      <tr><td style="color:var(--gris);">Spécialité</td><td><?php echo e($etudiant->specialite ?? '—'); ?></td></tr>
    </tbody>
  </table>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/cytech/Projet_Dev_Web/laravel_app/resources/views/etudiant/profil.blade.php ENDPATH**/ ?>