...
<div class="page-wrapper">
  ...
  <div class="panel-droit">
    <div class="form-zone">
      ...
      <form method="POST" action="<?php echo e(url('/login')); ?>" id="formLogin">
        <?php echo csrf_field(); ?>
        ...
        <a href="<?php echo e(route('forgot-password')); ?>" class="lien-oubli">Mot de passe oublié ?</a>

        <div class="mb-20">
          <label class="form-label" for="role">Votre rôle</label>
          <select id="role" name="role" class="form-select" required>
            <option value="" disabled <?php echo e(old('role') ? '' : 'selected'); ?>>Sélectionnez votre rôle</option>
            <option value="etudiant"   <?php echo e(old('role')=='etudiant'   ? 'selected' : ''); ?>>Étudiant</option>
            <option value="tuteur"     <?php echo e(old('role')=='tuteur'     ? 'selected' : ''); ?>>Tuteur / Professeur</option>
            <option value="entreprise" <?php echo e(old('role')=='entreprise' ? 'selected' : ''); ?>>Entreprise</option>
        ...
        <p style="font-size:13px;color:var(--gris);text-align:center;margin-top:20px;">
          ...
          <a href="<?php echo e(route('register')); ?>" style="color:var(--bleu-clair);text-decoration:none;font-weight:500;">S'inscrire</a>
        </p>
      </form>
    </div>
  </div>
...
<?php /**PATH /home/cytech/Projet_Dev_Web/laravel_app/resources/views/auth/login.blade.php ENDPATH**/ ?>