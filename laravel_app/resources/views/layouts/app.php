...
<head>
  ...
  <title><?= e($title) ?> — CY Tech</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600&family=DM+Serif+Display&display=swap" rel="stylesheet">
  <style>
    :root { --bleu:#1e5091; --bleu-clair:#4a7ec2; --bordure:#d5e1ee; --texte:#1c1c1c; --gris:#6b7280; --bg:#f3f6fb; }
    * { box-sizing:border-box; }
    ...
    .sidebar-logo { padding:0 24px 20px; border-bottom:1px solid rgba(255,255,255,0.1); margin-bottom:16px; display:flex; align-items:center; justify-content:center; }
    .sidebar-logo img { display:block; max-width:160px; height:auto; }
...
<nav class="sidebar">
  <div class="sidebar-logo">
    <img src="<?= url('/images/logo-cytech.png') ?>" alt="CY Tech">
  </div>
  ...
  <div class="sidebar-footer">
    <div class="user-info">
      <div class="avatar"><?= e(strtoupper(substr(session('prenom','?'),0,1).substr(session('nom','?'),0,1))) ?></div>
      <div>
        <div class="user-nom"><?= e(session('prenom')) ?> <?= e(session('nom')) ?></div>
        <div class="user-role"><?= e($role_label) ?></div>
      </div>
    </div>
