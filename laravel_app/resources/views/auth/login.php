...
<head>
  ...
  <style>
    :root { --bleu:#1e5091; --bleu-clair:#4a7ec2; --accent:#eaf1fa; --texte:#1c1c1c; --gris:#6b7280; --bordure:#d5e1ee; }
    * { box-sizing:border-box; margin:0; padding:0; }
    ...
    .panel-gauche { background:var(--bleu); display:flex; flex-direction:column; justify-content:center; align-items:center; padding:60px 56px; position:relative; overflow:hidden; text-align:center; }
    ...
    .logo-img { display:block; max-width:300px; height:auto; margin-bottom:40px; }
    .panel-gauche h1 { font-family:'DM Serif Display',serif; font-size:32px; color:white; line-height:1.25; max-width:380px; }
...
<div class="page-wrapper">
  ...
  <div class="panel-gauche">
    <img src="<?= url('/images/logo-cytech.png') ?>" alt="CY Tech" class="logo-img">
    <h1>Plateforme interne de stages</h1>
  </div>
